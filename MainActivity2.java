...
public class MainActivity2 extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b3.setText("Date , Time : " + date + " , " + time);
            ...
            public void onClick(View v) {
                ...
                CountDownTimer countDowntimer = new CountDownTimer(30000, 1000) {
                    ...
                    public void onFinish() {
                        Toast.makeText(MainActivity2.this, "Stop recording Automatically ", Toast.LENGTH_LONG).show();
                        //Insert into SQL
                        try {
                            sqlInsert();
                        } catch (SQLException throwables) {
                            throwables.printStackTrace();
                            Toast.makeText(MainActivity2.this,"Data insertion Failed",Toast.LENGTH_SHORT).show();
                        }
    ...
    public void sqlInsert() throws SQLException {
        if (connection != null){
            ...
            Toast.makeText(MainActivity2.this,"Data Insertion Successful",Toast.LENGTH_SHORT).show();
        }
        else {
            ...
            try {
                ...
                Toast.makeText(MainActivity2.this,"Connection Successful",Toast.LENGTH_SHORT).show();
                sqlInsert();
            }

            catch (SQLException | ClassNotFoundException e) {
                e.printStackTrace();
                Toast.makeText(MainActivity2.this,"Connection NOT Successful",Toast.LENGTH_SHORT).show();
            }
